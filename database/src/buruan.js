  const fs = require('fs')
  let _hasilBuruan = JSON.parse(fs.readFileSync('./database/src/hasil_buruan.json'))
  
  const addInventoriBuruan = (sender) => {
        const obj = {id: sender, ikan: global.buruan.ikan, ayam: global.buruan.ayam, kelinci: global.buruan.kelinci, domba: global.buruan.domba, sapi: global.buruan.sapi, gajah: global.buruan.gajah}
         _hasilBuruan.push(obj)
        fs.writeFileSync('./database/src/hasil_buruan.json', JSON.stringify(_hasilBuruan))
   }
